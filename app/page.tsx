...
export default function Home() {
  ...
  return <>
    <section className="home-hero">
      <Container className="home-hero__inner py-18 sm:py-24 lg:py-28">
        <div className="home-hero__content">
          <p className="eyebrow">GROWTH COMPANY ARCHIVE</p>
          <h1>성장주를 숫자와<br className="hidden sm:block" /> thesis로 읽습니다.</h1>
    ...
    <Container className="home-main py-16 sm:py-24">
      ...
      <section className="home-section metric-guide">
      ...
      <section className="home-section home-section--themes">
      ...
      <section className="home-section home-supply-section">
      ...
      <section className="home-section thesis-updates">
      ...
      <section className="home-section home-section--concepts">
