...
export default function Home() { return <>
  <section className="gridline hero-section relative overflow-hidden border-b border-[#20344c]"><Container className="relative py-20 sm:py-24 lg:py-28"><div className="max-w-3xl"><p className="eyebrow">미래 산업 기업 아카이브</p><h1 className="mt-4 text-4xl font-semibold leading-[1.15] tracking-tight sm:text-6xl">뉴스보다 먼저, <span className="text-cyan-300">기업이 하는 일</span>을 이해하세요.</h1><p className="mt-6 max-w-xl text-base leading-8 text-slate-300 sm:text-lg">AI, 반도체, 우주, 전력 인프라 기업을 사업 구조·핵심 지표·리스크 중심으로 읽기 쉽게 정리합니다.</p><div className="mt-9 flex flex-wrap gap-3"><Link className="primary-cta" href="/stocks">기업 설명서 보기</Link><Link className="secondary-cta" href="/methodology">아카이브 방법론 보기</Link></div></div><div className="mt-14 max-w-5xl"><ReadingGuideStepper /></div></Container></section>
