...
const featuredProfiles: Partial<Record<string, Pick<Stock, "description" | "kpis" | "bullCase" | "bearCase" | "risks" | "catalysts" | "quickFacts" | "observationPoints" | "businessSegments" | "whyItMatters" | "supplyChain">>> = {
  nvidia: {
    ...
    kpis: [{ label: "데이터센터 매출", status: "AI 수요 연결성 확인", description: "AI 인프라 수요가 실제 기업 매출로 이어지는지 보는 중심 지표입니다.", watchPoint: "다음 실적 자료에서 성장 흐름과 수요 설명이 이어지는지 확인", lastChecked: "2026-07-10", importance: "high" }, { label: "매출총이익률", status: "제품 구성 변화 점검", description: "제품 구성과 가격 결정력, 비용 구조가 어떻게 바뀌는지 보여 줍니다.", watchPoint: "신제품 전환과 공급 확대가 수익성에 주는 영향 확인", lastChecked: "2026-07-10", importance: "high" }, { label: "네트워킹 매출", status: "시스템 수요 동행 여부", description: "GPU 외 연결 장비 수요가 함께 커지는지 확인하는 단서입니다.", watchPoint: "AI 시스템 확장 시 네트워킹 수요도 함께 증가하는지 확인", lastChecked: "2026-07-10" }, { label: "재고", status: "수요·공급 균형 점검", description: "공급과 실제 고객 수요 사이에 과도한 간극이 없는지 점검합니다.", watchPoint: "재고와 공급 가능 물량이 고객 수요 설명과 일치하는지 확인", lastChecked: "2026-07-10" }, { label: "하이퍼스케일러 CAPEX", status: "외부 수요 신호", description: "대형 클라우드 기업의 설비투자 계획은 인프라 수요의 외부 관찰 포인트입니다.", watchPoint: "주요 고객의 투자 목적과 집행 속도 변화 확인", lastChecked: "2026-07-10" }],
