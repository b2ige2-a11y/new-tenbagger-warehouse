...
const featuredProfiles: Partial<Record<string, Partial<Pick<Stock, "description" | "kpis" | "bullCase" | "bearCase" | "risks" | "catalysts" | "quickFacts" | "observationPoints" | "businessSegments" | "whyItMatters" | "supplyChain" | "thesisLogs" | "sources" | "lastUpdated">>>> = {
  nvidia: {
    ...
    quickFacts: [{ label: "하는 일", value: "AI 연산용 GPU 플랫폼을 만듭니다" }, { label: "왜 유명한가", value: "GPU·네트워크·소프트웨어를 하나로 연결합니다" }, { label: "같이 보면 좋은 회사", value: "AMD · Broadcom · TSMC" }, { label: "관련 키워드", value: "GPU · CUDA · HBM" }],
    ...
    kpis: [{ label: "분기 매출", value: "$81.6B", change: "+85% YoY", period: "Q1 FY2027", description: "회사가 한 분기 동안 벌어들인 전체 매출입니다.", note: "게임, 데이터센터, 자동차 등 모든 사업을 합친 매출입니다.", watchPoint: "다음 분기에도 데이터센터 중심의 성장 흐름이 이어지는지", sourceLabel: "NVIDIA Earnings Release", sourceUrl: "https://investor.nvidia.com/news/press-release-details/2026/NVIDIA-Announces-Financial-Results-for-First-Quarter-Fiscal-2027/default.aspx", importance: "high" }, { label: "데이터센터 매출", value: "$75.2B", change: "+92% YoY", period: "Q1 FY2027", description: "AI 서버 수요가 실제 매출로 얼마나 이어지는지 보여 줍니다.", note: "AI 서버용 GPU와 네트워킹 사업의 크기를 이해하기 좋은 숫자입니다.", watchPoint: "클라우드 고객의 AI 인프라 투자가 계속 매출로 이어지는지", sourceLabel: "NVIDIA Earnings Release", sourceUrl: "https://investor.nvidia.com/news/press-release-details/2026/NVIDIA-Announces-Financial-Results-for-First-Quarter-Fiscal-2027/default.aspx", importance: "high" }, { label: "GAAP 매출총이익률", value: "74.9%", change: "+14.4pt YoY", period: "Q1 FY2027", description: "제품을 팔고 직접 비용을 제외한 뒤 얼마나 남는지 보여 줍니다.", note: "제품 구성과 가격, 공급 비용이 수익성에 미친 결과를 볼 수 있습니다.", watchPoint: "신제품 비중이 바뀌어도 현재 수준의 수익성을 유지하는지", sourceLabel: "NVIDIA Earnings Release", sourceUrl: "https://investor.nvidia.com/news/press-release-details/2026/NVIDIA-Announces-Financial-Results-for-First-Quarter-Fiscal-2027/default.aspx" }, { label: "데이터센터 네트워킹 매출", value: "$14.8B", change: "+199% YoY", period: "Q1 FY2027", description: "많은 GPU를 하나의 AI 시스템으로 연결하는 사업의 매출입니다.", note: "GPU뿐 아니라 전체 AI 시스템을 공급하는 회사인지 이해하는 데 도움이 됩니다.", watchPoint: "대형 AI 시스템 구축과 함께 네트워킹 수요도 이어지는지", sourceLabel: "NVIDIA Earnings Release", sourceUrl: "https://investor.nvidia.com/news/press-release-details/2026/NVIDIA-Announces-Financial-Results-for-First-Quarter-Fiscal-2027/default.aspx" }, { label: "재고", value: "$25.8B", period: "2026-04-26", description: "향후 판매와 생산을 위해 보유한 제품과 부품 규모입니다.", note: "수요에 대응할 준비와 공급 부담을 함께 살펴보는 숫자입니다.", watchPoint: "재고 증가가 실제 출하와 매출로 자연스럽게 이어지는지", sourceLabel: "NVIDIA Earnings Release", sourceUrl: "https://investor.nvidia.com/news/press-release-details/2026/NVIDIA-Announces-Financial-Results-for-First-Quarter-Fiscal-2027/default.aspx" }],
    thesisLogs: [{ date: "2026-07-10", items: ["NVIDIA Q1 FY2027 공식 실적 자료의 핵심 숫자를 반영했습니다.", "기업 설명을 초보자용 읽기 순서에 맞게 단순화했습니다."] }, { date: "2026-06-30", items: ["초기 기업 설명서를 작성했습니다."] }],
    sources: [{ label: "NVIDIA Q1 FY2027 Earnings Release", url: "https://investor.nvidia.com/news/press-release-details/2026/NVIDIA-Announces-Financial-Results-for-First-Quarter-Fiscal-2027/default.aspx", type: "earnings" }, { label: "NVIDIA Investor Relations", url: "https://investor.nvidia.com/", type: "ir" }, { label: "SEC Filings", type: "sec" }],
