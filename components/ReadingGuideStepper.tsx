const steps = [
  { number: "01", title: "무슨 회사인지 보기", description: "무엇을 만들고 누구에게 파는지부터 봅니다.", icon: <path d="M5 19V8l7-4 7 4v11M9 19v-5h6v5M8 9h.01M12 9h.01M16 9h.01" /> },
  { number: "02", title: "연결된 산업 보기", description: "어떤 기업·기술과 함께 움직이는지 봅니다.", icon: <path d="M6 7h4v4H6V7Zm8 0h4v4h-4V7ZM6 15h4v4H6v-4Zm8 0h4v4h-4v-4Zm-4-6h4m-6 2v4m8-4v4m-6 2h4" /> },
  { number: "03", title: "숫자로 확인하기", description: "매출과 이익률이 설명과 맞는지 확인합니다.", icon: <path d="M5 18V9m5 9V5m5 13v-6m4 6H3" /> },
];
